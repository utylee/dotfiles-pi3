./configure --with-features=huge --enable-multibyte --enable-rubyinterp=yes --enable-perlinterp=yes --enable-luainterp=yes --with-lua-prefix=/usr/local/ --enable-python3interp=yes --with-python3-config-dir=/home/utylee/.pyenv/versions/3.8.20/lib/python3.8/config-3.8-arm-linux-gnueabihf/ --enable-gui=gtk2 --enable-cscope
